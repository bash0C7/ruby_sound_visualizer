...
- [x] capture tab, capture videoした場合pref viewには表示されない（背景が黒のまま）、VJ viewには意図通りでてるよ
- [x] capture tabボタンはトグルのはずだが、押してもボタンが反転の色にならない。どのモードになってるかの把握をしたいため、ONのときは反転。も一度おしたらOFF。
- [x] capture cameraボタンはトグルのはずだが、押してもボタンが反転の色にならない。どのモードになってるかの把握をしたいため、ONのときは反転。も一度おしたらOFF。
- [x] pref viewボタンはトグルのはずだが、押してもボタンが反転の色にならない。どのモードになってるかの把握をしたいため、ONのときは反転。も一度おしたらOFF。
