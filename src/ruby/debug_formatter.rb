class DebugFormatter
  ...
  def format_debug_text(analysis, beat, bpm: 0)
    ...
    mode_str = build_mode_string(ColorPalette.get_hue_mode)
  ...
  def format_key_guide
    "m: Mic mute  |  t: Tab capture  |  0-3: Color Mode  |  4/5: Hue Shift  |  6/7: Brightness ±5  |  8/9: Lightness ±5  |  +/-: Sensitivity  |  [/]: Gain  |  a/s: Cam X  |  w/x: Cam Y  |  q/z: Cam Z"
  end
